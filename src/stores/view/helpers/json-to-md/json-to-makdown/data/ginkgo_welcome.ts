const md = `# 👋 Welcome to Gingko Writer
...
\\* *On macOS use <span class="shortcut-key">⌘</span> instead of <span class="shortcut-key">Ctrl</span>*
...
In classic procrastination-mode, instead of buckling down to write anyway, I went off on a long quest for better writing software! 😅
...
None of the software I found worked the way my mind did, so I decided to try designing my own.`;
export const ginkgo_welcome = { json, md, annotatedMd };
