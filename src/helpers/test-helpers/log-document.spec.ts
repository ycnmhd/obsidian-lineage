...
const n3_1 = "nuD9";
const n3_2 = "nhqd";
const input = {"columns":[{"id":c0,"groups":[{"nodes":[n1,n2,n3],"parentId":root}]},{"id":c1,"groups":[{"nodes":[n1_1,n1_2],"parentId":n1},{"nodes":[n2_1,n2_2],"parentId":n2},{"nodes":[n3_1,n3_2],"parentId":n3}]}],"content": {[n1]: { content: "1" },[n2]: { content: "2" },[n3]: { content: "3" },[n1_1]: { content: "1.1" },[n1_2]: { content: "1.2" },[n2_1]: { content: "2.1" },[n2_2]: { content: "2.2" },[n3_1]: { content: "3.1" },[n3_2]: { content: "3.2" }}}`;
