import { Column, DocumentState } from 'src/view/store/document-reducer';
...
import { findNextActiveNode } from 'src/view/store/reducers/creation/helpers/find-next-active-node';
